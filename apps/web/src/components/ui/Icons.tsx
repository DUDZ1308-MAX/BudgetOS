...
export function IconBudgets(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 20V10" />
      <path d="M18 20V4" />
...
export function IconMortgage(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function IconSparkles(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M18 5l.6 2.4L21 8l-2.4.6L18 11l-.6-2.4L15 8l2.4-.6z" />
      <path d="M7 14l.6 2.4L10 17l-2.4.6L7 20l-.6-2.4L4 17l2.4-.6z" />
    </svg>
  );
}
...
export function IconCrown(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 20h20" />
      <path d="M4 20V8l4 4 4-8 4 8 4-4v12" />
    </svg>
  );
}
...
export function IconRocket(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 2s-3 4-3 9c0 3.5 2 6 3 7 1-1 3-3.5 3-7 0-5-3-9-3-9z" />
      <circle cx="12" cy="9" r="2" />
      <path d="M5 17c-1 2-1 4-1 4s2 0 4-1" />
      <path d="M19 17c1 2 1 4 1 4s-2 0-4-1" />
    </svg>
  );
}
...
export function IconMegaphone(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M21 8a3 3 0 010 6" />
      <path d="M5 14H4a2 2 0 01-2-2v-2a2 2 0 012-2h1l5-4v12l-5-4z" />
      <path d="M16 7a5 5 0 010 10" />
    </svg>
  );
}
...
export function IconFeatureFlag(props: IconProps) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 21V3h13l-1 5 1 5H4" />
      <path d="M18 13v8" />
