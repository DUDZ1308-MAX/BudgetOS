  ...
  return (
    <>
      ...
      <div className="block md:hidden space-y-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 text-white shadow-lg">
            <IconPlanning className="h-4 w-4" />
          </div>
          <div>
            <h1 className="text-lg font-bold text-slate-900 dark:text-slate-100">Financial Planning</h1>
            <p className="text-xs text-slate-500 dark:text-slate-400">Scenario planning, forecasting, and goal optimization</p>
          </div>
        </div>
        ...
        {!hasData && (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-6 text-center dark:border-slate-700 dark:bg-slate-900">
            <IconPlanning className="mx-auto h-10 w-10 text-slate-300 dark:text-slate-600" />
            <h3 className="mt-3 text-base font-semibold text-slate-900 dark:text-slate-100">No Financial Data</h3>
